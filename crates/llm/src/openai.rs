...
fn convert_openai_response<T>(response: rig::completion::CompletionResponse<T>) -> LlmResponse {
...
impl LlmProvider for OpenAiProvider {
    async fn complete(
        ...
        let model: rig::providers::openai::responses_api::ResponsesCompletionModel =
        ...
        Ok(convert_openai_response(response))
    }
...
mod tests {
    use super::*;
    use crate::anthropic::split_system_and_chat;
    ...
    fn test_convert_messages_to_rig() {
        use crate::anthropic::convert_messages_to_rig;
        let messages = vec![
            LlmMessage::human("Hello there"),
    ...
    fn test_provider_name() {
        // Verify the string literal — no network call needed
